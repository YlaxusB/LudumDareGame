...
public class BoxHandler : MonoBehaviour
{
    ...
    {
        if (!isHoldingBox && collider.transform.tag == "Box" && !collider.GetComponent<BoxScript>())
        {
    ...
    private void Update()
    {
        ...
        if (Input.GetMouseButton(1) && isHoldingBox)
        {
            ...
            {
                BoxScript boxScript = box.AddComponent<BoxScript>();
    ...
    {
        float randomBoxZ = Random.Range(lastBoxZ + 40, lastBoxZ + 100);
